...
public class EditModel : PageModel
{
    ...
    public EditModel(AssetItemService assetItemService, PlantService plantService, IActivityLogger activityLogger)
    {
    ...
    public async Task<IActionResult> OnPostAsync(int id)
    {
        ...
        var updates = new AssetItem
        {
            ...
            Area = Input.Area,
            Train = Input.Train,
            // Condition (GVI) & Inspection and the picture are owned by the dedicated
            // Condition tab (EditCondition.cshtml) — carry them over unchanged so this
            // page's full-row UPDATE doesn't clobber that data.
            ...
            PicturePath = assetItem.PicturePath,
